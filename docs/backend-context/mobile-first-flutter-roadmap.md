...
| `PATCH` | `/api/v1/mobile/dashboard/settings` | Partial update (e.g. nested `payment`: cash/M-Pesa/Tumizi, default method); see `docs/backend-context/tumizi/TUMIZI_MOBILE_AND_SETTINGS.md` |
