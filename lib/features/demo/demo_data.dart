...
const demoOrders = <DemoOrder>[
  ...
  DemoOrder(
      id: '#ORD-1047',
      customer: 'Omondi Kevin',
      total: 'KES 9,200',
      status: 'Paid',
      time: '15 min ago'),
  DemoOrder(
      id: '#ORD-1046',
      customer: 'Grace Nyaga',
      total: 'KES 1,300',
      status: 'Packed',
      time: '38 min ago'),
  DemoOrder(
  ...
  DemoOrder(
      id: '#ORD-1044',
      customer: 'Miriam Akinyi',
      total: 'KES 2,100',
      status: 'Paid',
      time: '2 hrs ago'),
  DemoOrder(
      id: '#ORD-1043',
      customer: 'Faith Kendi',
      total: 'KES 5,700',
      status: 'Pending',
      time: '3 hrs ago'),
];
...
const demoCustomers = <DemoCustomer>[
  ...
  DemoCustomer(
      ...
      orderCount: 14,
      lastOrder: 'Yesterday',
      totalSpent: 'KES 52,100'),
  DemoCustomer(
      name: 'Grace Nyaga',
      email: 'g.nyaga@email.com',
      orderCount: 5,
      lastOrder: '3 days ago',
      totalSpent: 'KES 9,400'),
  DemoCustomer(
      name: 'Samuel Kiptoo',
      email: 's.kiptoo@email.com',
      orderCount: 22,
      lastOrder: '1 week ago',
      totalSpent: 'KES 81,200'),
  DemoCustomer(
      name: 'Miriam Akinyi',
      email: 'miriam.akinyi@email.com',
      orderCount: 3,
      lastOrder: '2 days ago',
      totalSpent: 'KES 6,750'),
  DemoCustomer(
      name: 'Faith Kendi',
      email: 'faith.kendi@email.com',
      orderCount: 11,
      lastOrder: 'Today',
      totalSpent: 'KES 34,300'),
  DemoCustomer(
      name: 'Sarah Jenkins',
      email: 'sarah.j@email.com',
      orderCount: 6,
      lastOrder: 'Oct 24',
      totalSpent: 'KES 18,400'),
  DemoCustomer(
      name: 'Marcus Thorne',
      email: 'marcus.thorne@email.com',
      orderCount: 19,
      lastOrder: 'Oct 24',
      totalSpent: 'KES 63,050'),
];
